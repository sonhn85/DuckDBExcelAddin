...
helper.o: helper.c helper.h
	gcc -O2 -c -o $@ -I. -I$(EXCEL_SDK_INC_PATH) $<

db_lib_loader.o: db_lib_loader.c db_lib_loader.h helper.h
	gcc -O2 -c -o $@ -I. -I$(EXCEL_SDK_INC_PATH) -I$(DUCKDB_INC_PATH) $<

db_xlrange.o: db_xlrange.c db_xlrange.h helper.h db_lib_loader.h
	gcc -O2 -c -o $@ -I. -I$(EXCEL_SDK_INC_PATH) -I$(DUCKDB_INC_PATH) $<

db_fetch.o: db_fetch.c db_xlrange.h helper.h db_lib_loader.h
	gcc -O2 -c -o $@ -I. -I$(EXCEL_SDK_INC_PATH) -I$(DUCKDB_INC_PATH) $<

DuckDBExcelAddin.o: DuckDBExcelAddin.c DuckDBExcelAddin.h helper.h db_lib_loader.h db_xlrange.h db_fetch.h
	gcc -O2 -c -o $@ -I. -I$(EXCEL_SDK_INC_PATH) -I$(FRAMEWRK_INC_PATH) -I$(DUCKDB_INC_PATH) $<
